...
const { checkId, checkBody, BasicRoutes } = require('../../middleware/index')

const options = { include: { model: Product }, nest: true, logging: false }

const br = new BasicRoutes()
br.setCheckId(checkId('Invalid Category Id.'))
  .setCheckBody(checkBody(['category_name'], 'Invalid Category Attribute.'))
  .setAllQuery(() => {
